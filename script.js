    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מכון פוליגרף שוקי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8df39329-0490-4a69-944e-9ba5a3bcae9e',
                    name: data.name || '',
                    email: data.email || '',
